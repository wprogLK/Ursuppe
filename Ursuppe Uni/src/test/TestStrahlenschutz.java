...
//public class TestStrahlenschutz implements ActionListener {
//
...
//		this.createSleeper();
//		
//		UrsuppeGUI ursuppe=new UrsuppeGUI(true);
//		//ursuppe.run();
//		
//	
//		
...
//		//BLUE//
//		//////////
//		this.playerBlue.addGene(GameGene.PortalGene);
//		int price=GameGene.PortalGene.getPrice();
//		assertThat(this.game.getBioPointsAtStart()-price,checkInteger.checkInteger(this.playerBlue.getBioPoints()));
//		assertThat(GameGene.PortalGene.getAvailableNrOfGenes(),checkInteger.checkInteger(0));
//		
//		this.playerBlue.setBioPoints(this.game.getBioPointsAtStart()); 
//		
//		this.playerBlue.addGene(GameGene.Wetterfrosch);
//		int price2=GameGene.Wetterfrosch.getPrice();
//		assertThat(this.game.getBioPointsAtStart()-price2,checkInteger.checkInteger(this.playerBlue.getBioPoints()));
//		assertThat(GameGene.Wetterfrosch.getAvailableNrOfGenes(),checkInteger.checkInteger(0));
//		
//		assertThat(this.playerBlue.getSumOfAllGenesOzoneValue(),checkInteger.checkInteger(11));
//		
//		this.playerBlue.setBioPoints(this.game.getBioPointsAtStart()); 
//		
//		
...
//		price=GameGene.Intelligence.getPrice();
//		assertThat(this.game.getBioPointsAtStart()-price,checkInteger.checkInteger(this.playerRed.getBioPoints()));
//		assertThat(GameGene.Intelligence.getAvailableNrOfGenes(),checkInteger.checkInteger(0));
//		
//		this.playerRed.setBioPoints(this.game.getBioPointsAtStart());
//		
//		this.playerRed.addGene(GameGene.TestGene);
//		price2=GameGene.TestGene.getPrice();
//		assertThat(this.game.getBioPointsAtStart()-price2,checkInteger.checkInteger(this.playerRed.getBioPoints()));
//		assertThat(GameGene.TestGene.getAvailableNrOfGenes(),checkInteger.checkInteger(1));
//		
//		this.playerRed.setBioPoints(this.game.getBioPointsAtStart());
//		
//		this.playerRed.addGene(GameGene.Sporen);
//		price2=GameGene.Sporen.getPrice();
//		assertThat(this.game.getBioPointsAtStart()-price2,checkInteger.checkInteger(this.playerRed.getBioPoints()));
//		assertThat(GameGene.Sporen.getAvailableNrOfGenes(),checkInteger.checkInteger(0));
//		
//		assertThat(this.playerRed.getSumOfAllGenesOzoneValue(),checkInteger.checkInteger(6));
//		
//		this.playerRed.setBioPoints(this.game.getBioPointsAtStart());
//		
//		this.goSleep();
