 ...
 *
 */
public class PhaseSetNamesGUI extends JPanel implements ActionListener 
{
...
//		JMenuItem menuItemCheat=new JMenuItem("go to cheats");
	 ...
	 * Constructor
	 */
	public PhaseSetNamesGUI(Game game, PhaseSetNames phase) {
