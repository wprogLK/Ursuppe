...
public class TestLebenserwartung implements ActionListener {
	...
	public UrsuppeGUI setNewPlayerData(UrsuppeGUI ursuppe)
	{
		...
		//BLUE//
		//////////
		this.playerBlue.addGene(GameGene.Lebenserwartung);
		
		int price=GameGene.Lebenserwartung.getPrice();
		assertThat(this.game.getBioPointsAtStart()-price,checkInteger.checkInteger(this.playerBlue.getBioPoints()));
		assertThat(GameGene.Lebenserwartung.getAvailableNrOfGenes(),checkInteger.checkInteger(0));
	...
	public UrsuppeGUI testDataPhase4(UrsuppeGUI ursuppe)
	{
		...
		/////FOR TESTING/////
		////SET DAMAGE POINT OF AMEBAS ON BOARD ==3//
	
		for (int i=0; i<this.playerBlue.getAmebasOnBoard().size();i++)
		{
			Ameba ameba=this.playerBlue.getAmebasOnBoard().get(i);
			
			ameba.setDamagePoints(3);
		}
	...
	public UrsuppeGUI testDataPhase5(UrsuppeGUI ursuppe)
	{
		...
		//FOR TESTING LEBENSERWARTUNGS GENE:
		assertThat(this.playerBlue.getAmebasOnBoard().size(),checkInteger.checkInteger(0));
	...
	public UrsuppeGUI testDataPhase6(UrsuppeGUI ursuppe)
	{
		...
		//*BLUE*//
		//////////
		assertThat(this.playerBlue.getScoreOfGenes(),checkInteger.checkInteger(1));
		assertThat(this.playerBlue.getAmebasOnBoard().size(),checkInteger.checkInteger(0));
		assertThat(this.playerBlue.getScore(),checkInteger.checkInteger(2));
