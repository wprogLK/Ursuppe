...
public class ScriptedGame1 implements ActionListener {
	...
	private final int nap_interval=1000;//800;		//0.8 (?) second nap //for in phases
	 ...
	 */
	@Test
	public Ursuppe scriptedGame1() 
	{
		
		this.createSleeper();
		
		//DR I get an assertion error here leading to Player.setScore so I can't correct more fix please!
	...
	public UrsuppeGUI startPhaseWelcome(UrsuppeGUI ursuppe)
	{
		assertThat(this.phaseLogic.getActivePhase(),checkPhase.checkPhase(GamePhases.phaseWelcome));							//Important! Each phase test must check this!
	...
	@Given("testDataPhase4")
	public UrsuppeGUI startPhase5(UrsuppeGUI ursuppe)
	{
		ursuppe.fakeTimer();
		
		assertThat(this.phaseLogic.getActivePhase(),checkPhase.checkPhase(GamePhases.phase5));								//Important! Each phase test must check this!
	...
	@Given("testDataPhase5")
	public UrsuppeGUI startPhase6(UrsuppeGUI ursuppe)
	{
		ursuppe.fakeTimer();
		assertThat(this.phaseLogic.getActivePhase(),checkPhase.checkPhase(GamePhases.phase6));								//Important! Each phase test must check this!
	...
	@Given("testScriptedGame1")
	public UrsuppeGUI testDataPhaseWelcome(UrsuppeGUI ursuppe)
	{
		PhaseWelcome phase=(PhaseWelcome) this.getObjectPhase(this.phaseLogic.getActivePhase());	//Important! Each phase test should have this line!
...
//		
//		
//		this.setAmebaPhaseSetFirstAmebaCheck(phase,this.playerYellow, 4,  0, true,  true,  true,  true,  1,  2 ,  2,  1);
//		this.goHavingANap(); //@for see only
//	
//		
//		/////////
...
//		
//		
//		//TODO: BUY GENES AND CHECK GENES 
//		
//		
//		////////////
//		//RED//
...
//		assertThat(this.playerBlue.getAmebasOnBoard().size(),checkInteger.checkInteger(2));
//		
//		phase.fakeClickbuttonSkipPlayer();
//		this.goHavingANap(); //@for see only
//		
...
//	}
//	
//	@Given("startPhase5") //Death
//	public UrsuppeGUI testDataPhase5(UrsuppeGUI ursuppe)
//	{
//		Phase5 phase=(Phase5) this.getObjectPhase(this.phaseLogic.getActivePhase());				//Important! Each phase test should have this line!
//		
//		assertTrue(this.game.getReadDirection()==GameReadDirection.down);
//		
//		
//		System.out.println("Check death amebas: please wait...");
//		while(!phase.getButtonGoToPhase6IsEnabled())		//This isn't a infinity loop!
//		{
//			//System.out.println("check Ameba: " + phase.getCurrentAmeba() + " ameba: " +phase.getDeathAmeba() +" is death now.");	//Wait until every ameba was checked (timer event)
//			System.out.print(""); //This is needed otherwise the game is here in a endless loop!
//		}
//		System.out.println("Finish check!");
//		this.goHavingANap(); //@for see only
//		
//		assertTrue(phase.getButtonGoToPhase6IsEnabled());
//		phase.fakeClickbuttonGoToPhase6();
//		return ursuppe;
//	}
//	
//	@Given("startPhase6")//Score
//	public UrsuppeGUI testDataPhase6(UrsuppeGUI ursuppe)
//	{
//		
//		Phase6 phase=(Phase6) this.getObjectPhase(this.phaseLogic.getActivePhase());				//Important! Each phase test should have this line!
//		
//		ISquare ladderSquare;
//		
//		while(!phase.getButtonGoToPhase1IsEnabled())
//		{
//			System.out.println("Please wait, I'm calculating the new score");
//		}
//		
//		////////////
//		//*YELLOW*//
//		////////////
//		assertThat(this.playerYellow.getScoreOfGenes(),checkInteger.checkInteger(0));
//		assertThat(this.playerYellow.getAmebasOnBoard().size(),checkInteger.checkInteger(2));
//		assertThat(this.playerYellow.getScore(),checkInteger.checkInteger(1));
//		
//		ladderSquare=this.game.getBoard().getLadderSquare(1);
//		System.out.println("ladder 1: "+ ladderSquare.getPlayer());
//		assertTrue(ladderSquare.getPlayer().equals(this.playerYellow));
//		
//		assertThat(this.playerYellow.getPosX(),checkInteger.checkInteger(ladderSquare.getX()));	//Check graphical location
//		assertThat(this.playerYellow.getPosY(),checkInteger.checkInteger(ladderSquare.getY()));	//Check graphical location
//		
//		//////////
//		//*BLUE*//
//		//////////
//		assertThat(this.playerBlue.getScoreOfGenes(),checkInteger.checkInteger(0));
//		assertThat(this.playerBlue.getAmebasOnBoard().size(),checkInteger.checkInteger(2));
//		assertThat(this.playerBlue.getScore(),checkInteger.checkInteger(2));
//		
//		ladderSquare=this.game.getBoard().getLadderSquare(2);
//		assertTrue(ladderSquare.getPlayer().equals(this.playerBlue));
//		
//		assertThat(this.playerBlue.getPosX(),checkInteger.checkInteger(ladderSquare.getX()));	//Check graphical location
//		assertThat(this.playerBlue.getPosY(),checkInteger.checkInteger(ladderSquare.getY()));	//Check graphical location
//		
//	
//		
//		/////////////////////////
//		//CHECK LADDERSQUARE 3://
//		/////////////////////////
//		ladderSquare=this.game.getBoard().getLadderSquare(3);
//		//assertTrue(ladderSquare.getPlayer()==null);
//		System.out.println("LADDER 2= " + this.game.getBoard().getLadderSquare(2).getPlayer());
//		System.out.println("LADDER 3= " + this.game.getBoard().getLadderSquare(3).getPlayer());
//		
//		ladderSquare=this.game.getBoard().getLadderSquare(4);
//		//assertTrue(ladderSquare.getPlayer()==null);
//		
//		System.out.println("LADDER 4= " + this.game.getBoard().getLadderSquare(4).getPlayer());
//		
//	
//		
//		//////////
//		//*RED*//
//		//////////
//		assertThat(this.playerRed.getScoreOfGenes(),checkInteger.checkInteger(0));
//		assertThat(this.playerRed.getAmebasOnBoard().size(),checkInteger.checkInteger(3));
//		assertThat(this.playerRed.getScore(),checkInteger.checkInteger(4));		//FIX THIS!!!! should be 4
//		
//		ladderSquare=this.game.getBoard().getLadderSquare(4);
//		System.out.println("LAdderSquare 4: " + ladderSquare.getPlayer());
//		assertTrue(ladderSquare.getPlayer().equals(this.playerRed));
//		
//		assertTrue(phase.getButtonGoToPhase1IsEnabled());
//		
//		assertThat(this.playerRed.getPosX(),checkInteger.checkInteger(ladderSquare.getX()));	//Check graphical location
//		assertThat(this.playerRed.getPosY(),checkInteger.checkInteger(ladderSquare.getY()));	//Check graphical location
//		
//		
//		
//		
//		System.out.println("Player YELLOW: " + this.playerYellow.getPosX() +" "+ this.playerYellow.getPosY());
//		System.out.println("Player RED: " + this.playerRed.getPosX() +" "+ this.playerRed.getPosY());
//		System.out.println("Player BLUE: " + this.playerBlue.getPosX() +" "+ this.playerBlue.getPosY());
//		
//		this.goSleep();
//		
//		if(this.seeEndBoard)
...
//	}
	...
	private Object getObjectPhase(GamePhases phase)
	{
