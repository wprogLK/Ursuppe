...
public class PhaseLogic extends JPanel implements ActionListener {
	 ...
	 * 
	 */
	public PhaseLogic(Game game, GamePhases startPhase)
	{
		//////////////////////////////////
	...
	private void createPhase() {
		...
		this.phaseWelcome=new PhaseWelcome(this.game);
	}
	...
	{
		//this.doUpdate(phase); //Update the data of the phase //TODO: is this line necessary
	...
	private void invariant() {
		ArrayList<Player> players=this.game.getOrderPlayers();
		
		Player headPlayer=players.get(0);
		Player tailPlayer=players.get(players.size()-1);
		Player emptyPlayer=this.game.getEmptyPlayer();
		
		assert (headPlayer.equals(emptyPlayer) && tailPlayer.equals(emptyPlayer));
	}
	...
	/**
	 * Special for phases cheat, about , load and save.
	 */
	private void setBeforePhase() {
		this.phaseCheat.setBeforePhase(this.activePhase);
		this.phaseAbout.setBeforePhase(this.activePhase);
		//this.phaseLoad.setBeforePhase(this.activePhase);
		//this.phaseSave.setBeforePhase(this.activePhase);
	}
...
//	
	...
	/////////////////////
		...
		//////////////////////
			 ...
			 */
			public Object getPhase(GamePhases phase)
			{
				switch(phase)
				{
					case phase0:
