...
public class Player extends JPanel{
	...
	public void addPayedDifference(int value)
	{
		this.payedDifference=this.payedDifference+value;
	}
	
	public void resetPayedDifference()
	{
		this.payedDifference=0;
	}
	
	public int getPayedDifference()
	{
		return this.payedDifference;
	}
	...
	{
		return this.playerName + ": " +this.color.toString().charAt(0);
	}
