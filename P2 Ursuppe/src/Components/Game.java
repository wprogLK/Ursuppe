///**
// * WRONG VERSION IN THE WRONG PACKAGE
// */
//package Components;
//
...
// * We haven't got a ASCII at the moment, but you and Aaron sad it will be ok if we have only a GUI, didn't you? Maybe we will implement this week a little 
// * ASCII. We will see...
...
//		int i=0;
//		while(this.getActualPlayer()==this.playerEmpty)	
//		{	
//			this.nextPlayer(); 
//			i++;
//		}
...
//				String infoYellow=this.playerBlue.description();
//				
