...
/**
 * This preparation phase is about set the first two amoebas on the board of every player
 * @author Lukas Keller
 * @version 1.0.0
 * 
 * @see IPhase
 */
public abstract class PhasePreparation3Logic extends PhaseTemplateLogic
{
	//////////
	//BASICS//
	//////////
	...
	public PhasePreparation3Logic(IModule module) 
	{
		super(module);
	}
