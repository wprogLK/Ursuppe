 ...
 * @see IPhase
 */
public abstract class CopyOfPhasePreparation1Logic_NEW_V6_B4_SUPERGOOD extends PhaseTemplateLogic
{
	...
	private void removePlaceholders() 
	{
		...
		for(Item currentItem:this.orderItems)
		{
			if(currentItem.getTyp()==EItem.Placeholder)
			{
				...
				else		//placeholder is/was head of the arrayList		//TODO TEST THIS!
				{
				...
				else		//placeholder is/was tail of the arrayList		//TODO TEST THIS!
				{
