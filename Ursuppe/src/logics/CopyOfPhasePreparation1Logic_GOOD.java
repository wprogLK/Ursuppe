 ...
 * @see IPhase
 */
public abstract class CopyOfPhasePreparation1Logic_GOOD extends PhaseTemplateLogic
{
	//////////
	//BASICS//
	//////////
...
//		
	...
	private ArrayList<Triple>  createNewOrder(ArrayList<Triple> inputOrder) 
	{
		...
		System.out.println("CREATE NEW ORDER START...");
		...
		while(currentTriple!=null)
		{
			...
			System.out.println("::::::::::::::::NEW TRIPLE IS " + currentTriple );
		}
...
//			if(triple==null)
//			{
//				System.out.println("ERROR TRIPLE IS NULL OBJECT!");
//			}
//			else
//			{
...
//			}
			if(triple.getType().equals("Placeholder"))
			{
				...
				System.out.println("FOUND PLACEHOLDER TO RECONSTRUCT..." + pTriple);
...
//				
				...
				System.out.println("FIRST T= " + firstTriple);
				System.out.println("LAST T= " + lastTriple);
				
				System.out.println("PREV T= " + prevTriple);
				System.out.println("NEXT T= " + nextTriple);
//				
				//if(prevTriple!=null)
				//{
