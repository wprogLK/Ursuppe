...
import logics.PhaseLoadGameLogic;

public class PhaseLoadGameASCII extends PhaseLoadGameLogic
{
	...
	/////////////
		...
		public PhaseLoadGameASCII(IModule module) 
		{
			super(module);
		}
		...
		{
			this.outStream.println(LanguagePack.getTranslation("phaseLoadGameTitle"));
		}
