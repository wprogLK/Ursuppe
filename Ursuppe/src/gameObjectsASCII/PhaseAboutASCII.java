...
import logics.PhaseAboutLogic;

public class PhaseAboutASCII extends PhaseAboutLogic
{
	...
	/////////////
		...
		public PhaseAboutASCII(IModule module) 
		{
			super(module);
		}
		...
		{
			this.outStream.println(LanguagePack.getTranslation("phaseAboutTitle"));
		}
