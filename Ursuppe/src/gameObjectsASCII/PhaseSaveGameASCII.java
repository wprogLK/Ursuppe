...
import logics.PhaseSaveGameLogic;

public class PhaseSaveGameASCII extends PhaseSaveGameLogic
{
	...
	/////////////
		...
		public PhaseSaveGameASCII(IModule module) 
		{
			super(module);
		}
		...
		{
			this.outStream.println(LanguagePack.getTranslation("phaseSaveGameTitle"));
		}
